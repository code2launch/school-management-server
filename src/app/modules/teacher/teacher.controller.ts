...
const createTeacher = catchAsync(async (req: Request, res: Response) => {
  ...
  sendResponse(res, { statusCode: httpStatus.CREATED, success: true, message: "Teacher created successfully.", data: result });
});
...
const getAllTeachers = catchAsync(async (req: Request, res: Response) => {
  ...
  sendResponse(res, { statusCode: httpStatus.OK, success: true, message: "Teachers fetched.", meta: result.meta, data: result.data });
});
...
const getTeacherById = catchAsync(async (req: Request, res: Response) => {
  ...
  sendResponse(res, { statusCode: httpStatus.OK, success: true, message: "Teacher fetched.", data: result });
});
...
const updateTeacher = catchAsync(async (req: Request, res: Response) => {
  ...
  sendResponse(res, { statusCode: httpStatus.OK, success: true, message: "Teacher updated.", data: result });
});
...
const deleteTeacher = catchAsync(async (req: Request, res: Response) => {
  ...
  sendResponse(res, { statusCode: httpStatus.OK, success: true, message: "Teacher deleted.", data: result });
});

const assignSubjects = catchAsync(async (req: Request, res: Response) => {
  const result = await TeacherService.assignSubjects(req.params.id, req.body.subjectIds);
  sendResponse(res, { statusCode: httpStatus.OK, success: true, message: "Subjects assigned.", data: result });
});
...
const getTeacherSubjects = catchAsync(async (req: Request, res: Response) => {
  ...
  sendResponse(res, { statusCode: httpStatus.OK, success: true, message: "Teacher subjects fetched.", data: result });
});

export const TeacherController = {
  createTeacher, getAllTeachers, getTeacherById, updateTeacher,
  deleteTeacher, assignSubjects, getTeacherSubjects,
};
